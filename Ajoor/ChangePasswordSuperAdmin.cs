...
namespace Ajoor
{
    public partial class ChangePasswordSuperAdmin : Form
    {
        SuperAdminRepo _SuperAdminRepo = new SuperAdminRepo();

        public ChangePasswordSuperAdmin()
        {
            InitializeComponent();
        }
        ...
        private void btn_Update_Click(object sender, EventArgs e)
        {
            try
            {
                if (txt_OldPassword.Text.Length >= 6 && txt_NewPassword.Text.Length >= 6 && txt_ConfirmPassword.Text.Length >= 6)
                {
                    ...
                    {
                        if (_SuperAdminRepo.ChangePassword(Utilities.USERNAME, txt_NewPassword.Text))
                        {
        ...
        private void ChangePasswordSuperAdmin_Load(object sender, EventArgs e)
        {
